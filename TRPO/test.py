...
for i in range(iterations):
    ...
    g = trpo.compute_objective_gradients(states, actions, Q).detach().transpose(0,1)
    ...
    s = cg.cg_torch(g, trpo.fvp, subsampled_states, g)


    #print("s: ", s)

    beta = trpo.beta_fvp(subsampled_states, 0.01, s)
    ...
    print_delta = theta_new / theta_old
